...
btngen.onclick = function () {
    var termStatDateOnMonday = new Date('2018-03-05T08:00:00');
    ...
    function recur(s) {
        ...
        sday = new Date(termStatDateOnMonday.getTime() + dayoffset.getTime());

        dayoffset = new Date(0);
    ...
    function startDateTime(s) {
        ...
        switch (switchTar[switchTar.length - 2]) {
            case '全':
                break;
            case '单':
                if (odd) ; else sday.setDate(sday.getDate() + 7);
                break;
            case '双':
                if (!odd) ; else sday.setDate(sday.getDate() + 7);
                break;
